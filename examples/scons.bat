...
set PATH=%NACL_SDK_ROOT%\third_party\python_26;%PATH%

:: Stop incessant CYGWIN complains about "MS-DOS style path"
set CYGWIN=nodosfilewarning %CYGWIN%

:: Run the included copy of scons.
python -O -OO "%NACL_SDK_ROOT%\third_party\scons-2.0.1\script\scons" --file=build.scons --site-dir="%~dp0nacl_sdk_scons" %*
