...
#ifndef DEBUGGER_CHROME_INTEGRATION_TEST_WINDOWS_THREAD_CONTEXT_H_
#define DEBUGGER_CHROME_INTEGRATION_TEST_WINDOWS_THREAD_CONTEXT_H_
#include <windows.h>
#include <winnt.h>
...
struct DECLSPEC_ALIGN(16) XSAVE_FORMAT {
    WORD   ControlWord;
    WORD   StatusWord;
    BYTE  TagWord;
    BYTE  Reserved1;
...
#endif DEBUGGER_CHROME_INTEGRATION_TEST_WINDOWS_THREAD_CONTEXT_H_
