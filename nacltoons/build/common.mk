...
OUTDIR?=.
OUTDIR:=$(OUTDIR)/$(TOOLCHAIN)/$(CONFIG)
-include $(OUTDIR)/*.d

SOURCE_DIRS:=$(sort $(dir $(SOURCES)))
OBJ_DIRS:=$(foreach source_dir,$(SOURCE_DIRS),$(OUTDIR)/$(source_dir))
$(OBJ_DIRS):
	$(MKDIR) -p $@
